"""
Wake word detection using OpenWakeWord (hey_jarvis model).
...
def get_oww():
    ...
    if _oww is None:
        ...
        log.info("Loading hey_jarvis wake word model…")
...
class WakeWordDetector:
    ...
    Returns True from process() when 'hey jarvis' is detected.
    """
